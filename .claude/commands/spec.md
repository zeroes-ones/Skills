# /spec — Generate a specification from an idea or requirement
...
**When to use**: Before writing any code for a new feature or product. The spec gates implementation — no code without a spec.
