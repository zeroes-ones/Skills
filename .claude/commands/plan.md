# /plan — Decompose a spec into an ordered task list with dependency graph
...
**What it produces**: A dependency-ordered task list. Each task: Objective, Files to create/modify, Acceptance Criteria, Verification steps, Estimated effort.
