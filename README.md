...
| [`scripts/skill-self-run.py`](scripts/skill-self-run.py) | Make ANY eligible skill self-run: backtrace prereqs → skill loops to its Verification → handoff to human gate (see `docs/self-running-skills.md`) |
