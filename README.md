...
**101 skills across 25 domains. 1,032 chain edges with 0 asymmetries. 150+ reference documents. 30+ asset templates.**
...
|---------|-------------|
| `skills-init` | Activate all 101 skills in current project (team/company default) |
...
# Startup or team project — full 101 skills
skills-init               # All 25 domains, 101 skills, full lifecycle coverage
```
