# /copilot-skill code-simplify — Simplify code while preserving behavior
...
**When to use**: When code is overly complex, has dead paths, or accumulates unnecessary abstractions.

**Workflow**:
1. Invoke `code-simplification` skill
2. Identify 5 categories: dead code, over-abstraction, complexity, duplication, inconsistency
...
**What it produces**: Cleaner code with fewer lines, fewer abstractions, and preserved behavior.
