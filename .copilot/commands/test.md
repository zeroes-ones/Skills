# /copilot-skill test — Write and run tests following TDD methodology
...
**What it produces**: Test files covering happy path, edge cases, error states, and concurrency. DAMP over DRY.
