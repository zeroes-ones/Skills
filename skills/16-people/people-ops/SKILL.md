...
1. **For employee relations investigations**.
2. **Recruiting pipeline management**.
3. **Payroll tax compliance**.
4. **Or employment law disputes**.
...
This table is specific to `people-ops`: each row names a failure this work actually produces, and the response that failure requires.
