...
1. **For analytics dashboard creation**.
2. **Statistical modeling**.
3. **ML pipeline serving**.
4. **Or BI tool configuration**.
...
This table is specific to `data-engineer`: each row names a failure this work actually produces, and the response that failure requires.
