...
1. **For data analysis** → route to `data-scientist`.
2. **Analytics-engineer)**.
3. **Building data pipelines** → route to `data-engineer`.
4. **Or web development** → route to `frontend-developer`.
...
This table is specific to `data-visualization-engineer`: each row names a failure this work actually produces, and the response that failure requires.
