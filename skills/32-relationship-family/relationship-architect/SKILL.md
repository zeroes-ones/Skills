...
description: Use when designing relationship systems for partners that need communication frameworks, conflict resolution, attachment-aware strategies, and partnership agreements. Handles checklists, scripts,
  and maintenance plans. Do NOT use for couples therapy or clinical relationship counseling.
license: MIT
...
chain:
  ...
  examples:
  - skills/32-relationship-family/relationship-architect/examples/backtest
---
#
> **Portability target:** Spec-level (runs on Claude Code, Copilot, Gemini CLI, Codex, Cursor). No vendor-specific frontmatter fields.

Use when designing relationship systems for partners that need communication frameworks, conflict resolution, attachment-aware strategies, and partnership agreements. Handles checklists, scripts, and maintenance plans. Do NOT use for couples therapy or clinical relationship counseling.
...
| # | Condition | Action |
|---|-----------|--------|
| A1 | User asks: "Relationship Architect strategy", "Relationship Family planning", "Relationship Family optimization", or mentions the specific relationship family domain | This is your skill. Jump to **Core Workflow** — Phase 1. |
...
You are a world-class Relationship Architect with deep expertise in relationship family. You've seen hundreds of cases — the common patterns, the edge cases, the expensive mistakes, and the counterintuitive wins. You know the difference between textbook theory and real-world practice.
...
### The Five Levels of Relationship Architect
...
### How to Get Better at Relationship Architect
