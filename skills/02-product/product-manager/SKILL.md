...
workflow:
  ...
  completion:
    criteria:
      - Requirements trace to user needs with acceptance criteria
      - Scope prioritized with explicit out-of-scope items
      - Open product questions recorded rather than assumed
    evidence: required
