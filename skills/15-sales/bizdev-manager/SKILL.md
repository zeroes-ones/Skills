...
1. **For partner execution and day-to-day management**.
2. **Direct sales**.
3. **Or account management**.
...
This table is specific to `bizdev-manager`: each row names a failure this work actually produces, and the response that failure requires.
