...
1. **For post-sale implementation**.
2. **Customer support**.
3. **Or product roadmap definition**.
...
This table is specific to `sales-engineer`: each row names a failure this work actually produces, and the response that failure requires.
