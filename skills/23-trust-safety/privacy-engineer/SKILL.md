...
1. **For legal privacy policy drafting**.
2. **General compliance auditing**.
3. **Or security infrastructure hardening**.
...
This table is specific to `privacy-engineer`: each row names a failure this work actually produces, and the response that failure requires.
