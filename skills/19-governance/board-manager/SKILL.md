...
| Gotcha | Cost | Fix |
|--------|------|-----|
| Board deck as an information dump without an ask — 80 slides of metrics, operational updates, and FYI items with no actual decision points. The board consumes information passively for 2 hours and adjourns without making a single decision. The meeting cost $50K in director fees plus travel and produced zero governance output. | $200K-$500K per year in wasted board meeting costs + strategic drift as critical decisions are deferred meeting after meeting + directors disengage and miss real problems when they eventually surface | Every board deck slide should either support a specific decision on the agenda or be cut. End each section with an explicit ask: "The board is asked to approve X," "Management seeks guidance on Y," or "For discussion: Z." If you can't articulate what you need from the board on a topic in one sentence, it doesn't belong in the deck. Pre-reads cover information; meeting time covers decisions. |
| Not documenting board decisions in minutes — the board agrees to authorize a $2M acquisition and a new executive compensation plan during the meeting. The minutes are drafted two weeks later from memory and omit key terms of both decisions. Six months later, no one can find formal documentation of the approvals. A departing director disputes what was actually decided. | $50K-$200K in legal remediation to reconstruct and ratify decisions retroactively + potential $500K-$2M in damages if a material transaction is successfully challenged + D&O insurance coverage disputes when there's no clear record of board authorization | Draft minutes within 48 hours of the meeting while memory is fresh. Record: motions made, seconds, vote counts, outcomes, and action items with owner and deadline. Minutes are a legal record, not a transcript — "the board discussed X" is sufficient; "John said Y and Sarah disagreed" is discoverable and dangerous. Formal written consents must be executed for all decisions made outside meetings. |
| Waiting until the board meeting to surface problems — management knows about a key customer churn event, a critical VP departure, and a 6-week product delay three weeks before the board meeting. They "save it for the board." The board has 8 minutes per crisis, makes rushed decisions under time pressure, and loses confidence in management's transparency. | $0 immediate but $5M-$50M in cascading costs — rushed strategic decisions made without adequate board deliberation, director trust erosion that slows approval velocity on every future decision, and the board shifting from strategic advisors to micromanagers who demand weekly operational updates | No-surprises rule: material problems go to the board chair and lead independent director within 24 hours of management awareness. A 15-minute pre-meeting call transforms a crisis from "Why are we learning this now?" to "Here's the situation, here's our plan, what guidance do you have?" The pre-meeting heads-up is the difference between the board as your strategic partner and the board as your auditor. |
