#!/usr/bin/env bash
# verify-skill.sh — Verification script for llm-search-optimizer skill
...
echo "=== LLM Search Optimizer — Skill Verification ==="
...
for ref in core-workflow.md decision-trees.md entity-markup-guide.md ai-crawler-registry.md monitoring-setup.md content-templates.md gotchas.md checklist.md; do
