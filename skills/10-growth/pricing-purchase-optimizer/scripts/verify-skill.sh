#!/usr/bin/env bash
# verify-skill.sh — Verification script for pricing-purchase-optimizer
set -euo pipefail
...
echo "=== Pricing Page & Purchase Flow Optimizer — Skill Verification ==="
...
# Reference files
for ref in pricing-page-audit.md behavioral-nudges.md checkout-flow-patterns.md ab-testing-pricing.md international-pricing-ux.md analytics-instrumentation.md dark-patterns-registry.md checklist.md; do
