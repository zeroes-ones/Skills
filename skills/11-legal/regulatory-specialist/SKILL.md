...
|---------|------------|-----|--------|
| FDA issued a Warning Letter for marketing an unclassified medical device | The software analyzed medical images and highlighted potential abnormalities -- classified as a medical device, but the company had assumed it was a general wellness product | Immediately cease marketing. Engage a regulatory consultant. File for 510(k) clearance or De Novo classification. Determine if a clinical hold or recall is needed. | SaMD classification is not optional. If your software interprets medical data for diagnostic or treatment decisions, it is a medical device. "It is just a tool" is not a defense against FDA enforcement. |
| ISO 13485 certification audit resulted in 3 major non-conformities for documentation gaps | Design History File (DHF) was assembled retroactively for the audit -- missing traceability from requirements to tests, and no evidence of design reviews | Implement eQMS with version-controlled documents and automated traceability. Conduct quarterly DHF audits. Assign document ownership per subsystem. | A QMS built for the audit instead of built for the process will fail the audit. Document as you develop, not before the inspector arrives. Traceability cannot be retroactively convincing. |
