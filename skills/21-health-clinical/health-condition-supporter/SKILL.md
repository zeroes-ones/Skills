...
| Gotcha | Cost | Fix |
|--------|------|-----|
| Condition supporter provides medical advice instead of self-management coaching — "You should try this medication" vs "Here's how to talk to your doctor about medication options." Directs treatment decisions without clinical authority. | $500K-$5M per incident in liability — giving medical advice without a license creates malpractice exposure, FDA enforcement for practicing medicine without authorization | Enforce strict boundary: all recommendations are about self-management process, not treatment decisions. Use disclaimers at every advice point. Train on the distinction between coaching and prescribing. |
| Symptom tracker designs produce data overload without actionable patterns — patient tracking 15+ symptoms at maximum granularity. "Everything is terrible all the time" with no signal amid the noise. | $100K-$300K per year in worsened outcomes — patients become more anxious, not more informed, driving up unnecessary utilization by 20-40% | Reduce to 3-5 most decision-relevant symptoms with functional anchors ("What couldn't you do because of this?"); set monthly review cadence; add context fields (time of day, recent activity) |
| Insurance navigation failure — appeal denied because it was filed at the wrong level (internal vs external review) or missing specific clinical evidence. Patient abandons treatment due to cost. | $100K-$500K per patient in delayed treatment and cost escalation — each appeal cycle takes 30-60 days; patients who abandon appeals have 3x worse outcomes | Build systematic appeal tracker: verify appeal level, confirm all required evidence attached, include provider letter addressing each denial reason point-by-point, track deadlines |
| Medication list drifts from reality — patient sees 5 specialists but no one maintains a master medication list. Drug-drug interactions go undetected across prescribers. | $200K-$1M per serious ADE — polypharmacy errors from uncoordinated prescribing cause 10-15% of hospital admissions in complex patients, each costing $15K-$30K | Maintain patient-controlled master medication record with name, dose, frequency, prescriber, reason, and start date; schedule annual brown-bag medication review with PCP or pharmacist |
