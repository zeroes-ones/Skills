...
| Opening a community space before it is seeded | $10,000-$80,000 in burned acquisition | Recruit 20-50 founding members per space before opening; pre-seed a founder story, newcomer guide, and 3-5 real questions with answers. Measure time-to-first-meaningful-connection (<48h), not signups or first-response time. |
