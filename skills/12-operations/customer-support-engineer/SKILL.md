...
workflow:
  ...
  completion:
    criteria:
      - Every escalated ticket has a shared investigation document
      - Acknowledgment time recorded against the SLA window
      - Zero DEBUG or inspector modes enabled in production
    evidence: required
