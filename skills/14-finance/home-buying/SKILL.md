...
|---------|-----------|-----|--------|
| "We waived inspection to make our offer competitive" — $28K in undisclosed foundation repairs needed month 2 | In a hot market, buyer's agent suggested waiving inspection contingency to win. Seller's disclosure was "clean" but omitted known issues. No recourse because inspection was waived. | Never waive inspection entirely. Offer "pass/fail inspection" (walk-away right preserved but seller knows you won't nickel-and-dime) or "inspection with $5K repair cap." Bring inspector for 30-minute walk-and-talk before offering in competitive situations. | A $500 inspection that catches $15K-$50K in defects is the best insurance policy in real estate. The only time to waive is when you have cash reserves to cover a worst-case $50K repair — and even then, don't. |
| Fixed-rate mortgage payment jumped from $2,100 to $2,850 in year 6 — "I thought we had a fixed rate" | Buyer signed a 5/1 ARM without understanding it. Loan officer pitched it as "fixed rate" because the rate is fixed for 5 years. Page 27 of 40-page closing doc had the ARM rider. Rate reset from 3.5% to 6.75% at first adjustment. | Read the Note (the promise to pay) — it's usually 2-3 pages and contains the actual rate structure. If it says "Adjustable Rate Note," you have an ARM regardless of what the Loan Estimate header says. Ask: "What is my rate in year 6? Year 8? What's the lifetime cap?" | "Fixed rate" in a lender's mouth often means "fixed for the initial period." The Note — not the Loan Estimate, not the verbal promise — is the legal document. Read those 3 pages. |
| "The bank approved us for $550K, so our $525K offer is within budget" — house-poor within 6 months | Pre-approval is based on gross income at 43% DTI. After taxes, insurance, 1.5% maintenance, and utilities, actual housing costs consumed 58% of take-home pay. Zero left for savings, vacations, or car repairs. | Run your own budget with NET income. PITI + 1-2% maintenance + utilities + HOA should be ≤ 28-30% of take-home pay (not gross). The bank's number is a maximum — your number is your actual life. | Lender pre-approval answers "what's the most they'll lend you." Your budget answers "what can you actually afford while still living your life." These are different questions with different answers. |
| Closing costs came in at $14,500 when buyer budgeted $6,000 — had to liquidate emergency fund | Buyer budgeted 3% for down payment and assumed closing costs were "a few thousand." Actual costs: loan origination ($3K), appraisal ($600), title insurance ($2K), escrow ($1.5K), prepaid taxes/insurance ($4K), attorney ($1.5K), misc ($1.9K). | Budget closing costs at 3-5% of purchase price IN ADDITION to down payment. Get a Loan Estimate within 3 business days of application — it's legally required and itemizes every cost. Compare 3+ lenders' Loan Estimates on the same day. | You need: down payment + closing costs (3-5%) + 3-6 months emergency fund AFTER closing. If you can't cover all three, you're not ready to buy — the house will find ways to cost more than you planned. |
| PMI still being paid 3 years after LTV hit 78% — $4,200 in unnecessary premiums | Home value appreciated significantly but servicer doesn't automatically cancel PMI at 78% LTV based on original value — only based on scheduled amortization. Borrower never requested cancellation based on current value. | Track your LTV annually. At 80% LTV (based on current appraised value, not purchase price), request PMI cancellation in writing. At 78% (scheduled amortization date), servicer must cancel automatically by law — but only based on original amortization schedule. For market appreciation, YOU must request it. | PMI cancellation is NOT automatic when your home appreciates — you must request it, pay for an appraisal ($400-$600), and prove current LTV ≤ 80%. The $600 appraisal that eliminates $150/month PMI pays for itself in 4 months. |
