...
description: Use when structuring important personal decisions. Handles bias mitigation, decision matrices, expected value, pre-mortems, reversibility analysis, decision journaling, Bayesian updating, and
  speed frameworks. Do NOT use for formal organizational governance or legal rulings.
license: MIT
...
Use when structuring important personal decisions. Handles bias mitigation, decision matrices, expected value, pre-mortems, reversibility analysis, decision journaling, Bayesian updating, and speed frameworks. Do NOT use for formal organizational governance or legal rulings.
...
### The Five Levels of Decision Engineer
...
### How to Get Better at Decision Engineer
