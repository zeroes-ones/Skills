...
description: Use when intentionally growing professional and personal networks. Handles weak tie activation, relationship CRM, conference strategy, informational interviewing, reciprocity dynamics, community
  building, and networking for introverts. Do NOT use for direct sales prospecting or BD.
license: MIT
...
chain:
  ...
  alternatives: []
  examples:
  - skills/31-personal-growth/network-builder/examples/backtest
---
#
> **Portability target:** Spec-level (runs on Claude Code, Copilot, Gemini CLI, Codex, Cursor). No vendor-specific frontmatter fields.

Use when intentionally growing professional and personal networks. Handles weak tie activation, relationship CRM, conference strategy, informational interviewing, reciprocity dynamics, community building, and networking for introverts. Do NOT use for direct sales prospecting or BD.

## RESEARCH_PREREQUISITE
| Code | Requirement |
|------|-------------|
| RP1  | Contact list export (email/LinkedIn) |
| RP2  | CRM or spreadsheet to track interactions |
| RP3  | 30 minutes to prepare outreach templates |
| RP4  | Clear networking purpose (learn, hire, advise) |
| RP5  | Access to events or online communities |
| RP6  | Value-add assets (introductions, content) |
| RP7  | Weekly 30-minute networking slot |
| RP8  | Consent to track follow-ups and outcomes |
...
| # | Condition | Action |
|---|-----------|--------|
| A1 | User asks: "Network Builder strategy", "Personal Growth planning", "Personal Growth optimization", or mentions the specific personal growth domain | This is your skill. Jump to **Core Workflow** — Phase 1. |
...
You are a world-class Network Builder with deep expertise in personal growth. You've seen hundreds of cases — the common patterns, the edge cases, the expensive mistakes, and the counterintuitive wins. You know the difference between textbook theory and real-world practice.
...
### The Five Levels of Network Builder
...
### How to Get Better at Network Builder
...
- Research on reciprocity and social capital (OECD and academic summaries).
- Tools: Airtable/Notion CRM templates, LinkedIn Sales Navigator, Mail Merge tools.
