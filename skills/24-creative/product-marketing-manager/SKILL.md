...
|---------|-----------|-----|--------|
| Product launch campaign generates 50K clicks but 0 conversions — landing page still says "Coming Soon" | Marketing rushed the campaign launch date to hit a quarterly goal. Product team was 2 weeks behind. Marketing launched the awareness campaign before the product was buyable. | Gate campaign launch on a product-readiness checklist: (1) purchase flow live and tested, (2) sales team trained, (3) support docs published, (4) landing page switched from "Coming Soon" to "Buy Now." Marketing doesn't launch until product signs off. | Clicks without a buy button are just expensive noise. Never launch a demand-gen campaign against a "Coming Soon" page. |
| Positioning statement tested terribly with the target ICP but nobody told the exec team — they launched with it anyway | The positioning research showed the target audience didn't understand the value prop. The CMO had already approved the messaging and didn't want to "look indecisive" by changing it. | Socialize positioning test results before executive approval, not after. Use a "green/yellow/red" stoplight system: red (tested poorly) = do not launch with this messaging. Build a culture where data overrides ego — celebrate changing course based on evidence. | Positioning is a hypothesis until tested with customers. Executive approval doesn't validate the hypothesis — customer response does. |
| Competitor launches an identical feature 3 weeks before your launch — your "first-to-market" messaging is dead | The competitive intel was based on a 6-month-old landscape analysis. The competitor had been beta-testing the same feature for 4 months and you missed all the signals (job postings, patent filings, beta signup pages). | Run competitive monitoring continuously, not just before launches. Track competitor changelogs, job postings (hiring "senior X developer" signals a build), patent applications, and beta program signups. Set Google Alerts for competitor product names. Update battle cards monthly. | Competitive landscape changes in weeks, not quarters. Your "unique differentiator" can become "me too" before your launch date. |
| Case study pipeline is empty because customer success never flagged the 3 accounts that would make perfect stories | Marketing asked for case study candidates 2 weeks before launch. The 3 best-fit customers are all mid-implementation and can't participate until Q3. The launch goes out with no customer proof. | Build a case study pipeline 6 months ahead of launch. Work with customer success to identify and nurture reference accounts early. Offer incentives (discount, swag, conference speaking slot). Get legal approval for customer logo usage months before you need it. | Case studies take 6-12 weeks from ask to publish. You can't close that gap 2 weeks before launch. |
| Pricing page A/B test runs for 2 weeks but results are invalid because the test overlapped with a holiday weekend | The test ran Dec 20 - Jan 3. Holiday traffic has completely different buyer intent (gift purchasing vs B2B procurement). The "winner" was optimized for holiday shoppers, not your actual ICP. | Never run pricing tests during holidays, end-of-quarter, or major industry events. Minimum test duration: 2 full business weeks with no anomalies. Segment results by traffic source — organic vs paid vs referral often have different conversion profiles. | A/B test timing matters as much as sample size. Holiday traffic is not your normal traffic, and holiday buyers are not your normal buyers. |
